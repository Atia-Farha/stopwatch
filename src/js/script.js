...
function lapTime() {
    ...
    lapDiv.innerHTML = `<span class="lapCounter"><p class="animate__animated animate__slideInDown animate__faster">Lap - ${lapCounter++}</span><span class="lapTime">${lapTimeString}</span></p>`;
